...
[Before/After screenshots for UI changes or Loom/video for UX flows]
...
## 🛡️ Impact Assessment
- **Security**: [No impact / New permissions needed / etc.]
- **Performance**: [No impact / Optimization made / etc.]
- **Accessibility**: [No impact / Verified with `axe` or `expect(page).to be_accessible`]
...
## 🔜 Follow-ups / PENDING
[List any follow-ups or tech debt remaining]
